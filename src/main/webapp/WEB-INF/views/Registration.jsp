...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    ...
    <body>
        <div class="container">
            ...
            <header>
                <h1>Trade System <span> Login to my System</span></h1>
                        ...
                        <div id="login" class="animate form">
                            ...
                            <form:form action="register" method="post" commandName="userForm">
                                ...
                                <p> 
                                    ...
                                    <form:input id="username" path="username" required="required" type="text" placeholder="mysuperusername690" />
                                </p>
                                <p> 
                                    <label for="email" class="youmail" data-icon="e" > Your email</label>
                                    <form:input id="email" path="email" required="required" type="email" placeholder="mysupermail@mail.com"/> 
                                </p>
                                <p> 
